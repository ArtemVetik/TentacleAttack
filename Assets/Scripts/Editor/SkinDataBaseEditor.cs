...
public class SkinDataBaseEditor : Editor
{
    ...
    private void OnEnable()
    {
        ...
        _dataBaseListInfo = allFields.ToList().Find((field) => field.FieldType.IsEquivalentTo(typeof(List<SkinData>)));
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.LabelField("SKIN DATA BASE", headerTextStyle);
        GUILayout.FlexibleSpace();
        ...
        GUILayout.BeginHorizontal();
        EditorGUILayout.LabelField("Current skin index: " + _currentRenderIndex, defaultTextStyle);
    ...
    private void RenderElement(SerializedProperty element)
    {
        ...
        EditorGUILayout.PropertyField(element.FindPropertyRelative("_texture"));

        var sprite = element.FindPropertyRelative("_texture").objectReferenceValue as Sprite;
    ...
    private List<int> GetFailedIndexes(SerializedProperty array)
    {
        ...
        for (int i = 0; i < array.arraySize; i++)
        {
            ...
            fieldList.Add(element.FindPropertyRelative("_texture").objectReferenceValue);
